...
for x in range(len(pri_only_subnets)):
    ...
    sleep(1)
#print ResTags(resource_session).tag_subnet(False, pri_only_subnets[1], tags('private02'))
#sleep(1)
#print ResTags(resource_session).tag_subnet(False, pri_only_subnets[2], tags('private03'))
#sleep(1)
#print ResTags(resource_session).tag_subnet(False, pri_only_subnets[3], tags('private04'))
...
#ssh_rule = create_ingress_rules(resource_session, from_port=22, to_port=22, cidr='10.0.0.0/24')
...
if results.environment == 'staging':
    ...
    core_api_rules_80 = create_ingress_rules(resource_session, sgid=core_api_sg_id, from_port=80, to_port=9000, cidr='10.0.0.0/24')
    core_api_rules_443 = create_ingress_rules(resource_session, sgid=core_api_sg_id, from_port=80, to_port=9000, cidr='172.31.0.0/16')
    core_api_rules_443 = create_ingress_rules(resource_session, sgid=core_api_sg_id, from_port=443, to_port=9000, cidr='10.0.0.0/24')
    core_api_rules_elb = create_ingress_rules(resource_session, sgid=core_api_sg_id, from_port=443, to_port=9000, cidr='172.31.0.0/16')
    ...
    core_api_rules_443 = create_ingress_rules(resource_session, sgid=core_api_sg_id, from_port=443, to_port=80, cidr='10.0.0.0/24')
    core_api_rules_elb = create_ingress_rules(resource_session, sgid=core_api_sg_id, from_port=443, to_port=80, cidr='172.31.0.0/16')
